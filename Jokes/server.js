...
require("./server/routes/joke.routes")(app); //have to pass in "app" keyword into routes file so that the routes file knows which "app is going to have our routes"
